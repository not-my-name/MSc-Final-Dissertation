...
Any given environment contains a finite number of resources. The maximum amount of life that this environment can support with these restricted resources, is referred to as its 'carrying capacity'
...
On the other hand, random genetic mutations and crossover during sexual reproduction have been identified as the microscopic driving factors behind the process of evolution through natural selection. 
...
% ^^
% Specifically, DNA is made of only 4 base proteins (adenine, cytosine, guanine, thymine) / nucleotides. The DNA (genotype) of all biological organisms are constructed using only these 3 nucleotides (discrete building block). The possible diversity is apparent in the massive variety of vharacteristics across various species.
